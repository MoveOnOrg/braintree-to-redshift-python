...
class BraintreeConnection(unittest.TestCase):
    def setUp(self):
        ...
        self.initial_transactions_count = len(list(get_transactions(end_date = self.end_date, days = self.day_diff)))
    ...
    def test_create_transaction(self):
        ...
        self.current_transactions_count = len(list(get_transactions(end_date = self.end_date, days = self.day_diff)))
    ...
    def test_get_transactions(self):
        transactions = len(list(get_transactions(end_date = self.end_date, days = self.day_diff)))
